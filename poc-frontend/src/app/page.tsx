...
export default function HomePage() {
  ...
  return (
    <WavyBackground className="w-[100vw] mx-auto pb-40">
      ...
      <Suspense fallback={<div className="flex justify-center mt-10"><div className="animate-spin rounded-full h-10 w-10 border-t-2 border-b-2 border-white"></div></div>}>
        <AuthHandler
          router={router}
          loading={loading}
