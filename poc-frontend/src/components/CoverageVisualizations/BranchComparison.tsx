        ...
        <div className="overflow-x-auto">
            ...
            <tbody>
              ...
              <tr key={index} className={index % 2 === 0 ? 'bg-orange-50' : ''}>
                <td className="py-2 px-4 text-sm font-mono truncate max-w-xs text-gray-700" title={diff.file}>
                {diff.file}
                </td>
                ...
                <td className={`py-2 px-4 text-right font-medium ${getColorForDiff(diff.diff)} text-gray-700`}>
    ...
    <div className="bg-white rounded-lg border border-orange-100 p-4">
      ...
      <div className="flex flex-col md:flex-row gap-4 mb-4">
        <div className="flex-1">
          <label className="block text-sm font-medium text-gray-700 mb-1">Branch 1</label>
          <select
            value={branch1}
            onChange={(e) => setBranch1(e.target.value)}
            className="w-full p-2 bg-orange-50 text-gray-900 rounded border border-orange-200"
          >
        ...
        <div className="flex-1">
          <label className="block text-sm font-medium text-gray-700 mb-1">Branch 2</label>
          <select
            value={branch2}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-orange-50 p-4 rounded-lg border border-orange-100">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <p className="text-sm text-gray-500">Branch 1: {compareResult.branch1}</p>
                ...
                <div>
                  <p className="text-sm text-gray-500">Branch 2: {compareResult.branch2}</p>
            ...
            <div className="bg-orange-50 p-4 rounded-lg border border-orange-100">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="text-center p-3 bg-white rounded-lg">
                  <p className="text-sm text-gray-500">Improved Files</p>
                  <p className="text-2xl font-bold text-green-600">
                    {compareResult.file_diffs.filter(d => d.diff > 0).length}
                  </p>
                </div>
                <div className="text-center p-3 bg-white rounded-lg">
                  <p className="text-sm text-gray-500">Declined Files</p>
